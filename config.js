...
global.syt = 'https://youtube.com/@akunytbang1662'
global.sgh = 'https://github.com/Rellbot124/'
global.sgc = 'https://chat.whatsapp.com/FEqwjSoAurX44Xg1peCPeH'
global.swa = 'wa.me/6283152847785'
global.stg = 't.me/Hackerberkumis'
global.swb = 'https://'
...
global.povo = '085775757194'
global.pgopay = '085775757194'
global.ppulsa = '085775757194'
global.ppulsa2 = '083152847785'
global.psaweria = 'https://saweria.co/Dazx'

/*============== NOMOR ==============*/
global.nomorbot = '6281515483778'
global.nomorown = '6283152847785'
global.namebot = 'Fatanbot'
global.nameown = 'Lord DosQ'


/*============== STAFF ==============*/
global.owner = [
  ['6283152847785', 'Lord DosQ', 'true']
...
/*============== WATERMARK ==============*/
global.wm = `© copyright ${global.Lord DosQ} || ${global.Fatanbot}` //Main Watermark
global.wm2 = `${global.Fatanbot}`
global.wm3 = `${global.Lord DosQ}`
global.botdate = `私 𝗗𝗮𝘁𝗲: ${week} ${date}\n私 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `私 𝗧 𝗜 𝗠 𝗘 : ${wktuwib}`
global.titlebot = `${global.Fatanbotbot} Multi Device㐅 | ${global.Lord DosQ}`
global.author = `© ${global.Lord DosQ}`
global.packname = `\n\n\n\n\n\n\n ${global.Lord DosQ}`
global.danied = '*𝗘𝗥𝗥𝗢𝗥*'
...
/*============== GLOBAL BIO ==============*/
global.nameowner = `${global.LordDosQ}`
global.umurowner = '15'
global.asalowner = 'Banten'
global.nomorowner = 'wa.me/6283152847785'
global.pacarowner = 'Gapunya><'

/*============== TEXT ==============*/
global.wait = '_In progress, please wait..._'
global.eror = '```GAGAL```'
global.cptnya = `_Nih kak_\n\nJangan lupa mampir di channel *KAZEDEVID*`
global.botintro = `Hai👋 Saya Adalah Bot WhatsApp Yang Bernama ${global.Fatanbot}, Saya di buat oleh ${global.Lord DosQ} yang menggunakan bahasa nodejs`
global.anticall = `kamu Di blockir oleh ${global.Fatanbot} karena telah melanggar aturan ${global.Fatanbot}\n\n*📮Dilarang menelepon ${global.Fatanbot}!*`
global.antiasing = ` See You Next Time `
global.antispam = `*📌Kamu di banned karena spam*\n\n*💬Laporkan masalah ini ke ${global.083152847785}?text=📧Bang+Unban+Nomorku+Dong+Pliss🙏🙏*`
...
/*============== STICKER WM ==============*/
global.stickpack = `Made in ${global.Fatanbot} || `
global.stickauth = `${global.Lord DosQ}`
